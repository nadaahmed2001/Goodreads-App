      ...
      <div className="container mt-5">
        <div className="row align-items-center">
          ...
          <div className="col-md-6">
            ...
            <p className="lead">
              is a place where books lovers can find, review, and buy books easily.
              Discover recommendations, keep a reading lists, and shop for your next read.
              All in one Place.
            </p>
          </div>
        </div>
            ...
            <div className="card-body d-flex align-items-center">
              ...
              <div>
                ...
                <p className="text-muted">
                  ...
                  writer in the English language. Known as the 'Bard of Avon'.
                  His works include 38 plays, 154 sonnets, and two long narrative poems.
                </p>
              </div>
            </div>
          </div>
            ...
            <div key={index} className="col-md-3">
              <div className="card book-card">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text text-muted">Author: {books.author}</p>
